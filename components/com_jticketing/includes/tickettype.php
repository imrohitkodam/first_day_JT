...
class JTicketingTickettype extends CMSObject
{
	...
	/**
	 * Maximum ticket one can purchase against this ticket type per order
	 *
	 * @var    integer
	 * @since  2.5.0
	 */
	public $max_ticket_per_order = 0;
	...
	public function load($id)
	{
		...
		if ($table->load($id))
		{
			...
			$this->max_ticket_per_order = (int) $table->get('max_ticket_per_order');
